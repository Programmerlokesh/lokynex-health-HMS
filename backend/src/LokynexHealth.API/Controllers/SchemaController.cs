...
public class SchemaController : ControllerBase
{
    ...
    public SchemaController(IGenericTenantDataService dataService)
    {
    ...
    {
        return Ok(await _dataService.GetTablesAsync(cancellationToken));
    }
    ...
    public async Task<IActionResult> GetById(string tableName, Guid id, CancellationToken cancellationToken)
    {
    ...
    public async Task<IActionResult> Delete(string tableName, Guid id, CancellationToken cancellationToken)
    {
